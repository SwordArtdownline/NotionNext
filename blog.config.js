...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，我是牛牛, Hi，我是一個大學生,Hi，我是一個乾飯人,熱衷於技術🖱️和音樂🎸,在INTP與INTJ反復橫跳,歡迎來到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '牛 牛', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一個技術愛好者搭建的博客', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.niuniu2077.cc', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, Blog, Niu Niu', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'zihaoliu8843@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://raw.githubusercontent.com/SwordArtdownline/image-hosting/refs/heads/main/%E4%B8%8D%E7%BB%99%E4%BD%A0%E7%9C%8B.jpeg', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/SwordArtdownline', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || 'https://t.me/niuniu2077', // 你的telegram 地址 例如 https://t.me/niuniu2077
  CONTACT_LINKEDIN: process.env.NEXT_PUBLIC_CONTACT_LINKEDIN || 'https://steamcommunity.com/id/niuniu2077/', // 你的linkedIn 首页
  CONTACT_INSTAGRAM: process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM || '', // 您的instagram地址
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/629107630?spm_id_from=333.1007.0.0', // B站主页
  CONTACT_YOUTUBE: process.env.NEXT_PUBLIC_CONTACT_YOUTUBE || 'https://www.youtube.com/@N.N-XXD', // Youtube主页
  ...
  CONTACT_WEHCHAT_PUBLIC: process.env.NEXT_PUBLIC_CONTACT_WEHCHAT_PUBLIC || 'https://mp.weixin.qq.com/s/SvjrlPyGUkmEYkX7b_eH_w?token=219715600&lang=zh_CN', // 微信公众号 格式：https://mp.weixin.qq.com/mp/profile_ext?action=home&__biz=Mzk1NzY3NDA5OQ==#wechat_redirect
  ...
  // 文章URL前缀
  POST_URL_PREFIX: process.env.NEXT_PUBLIC_POST_URL_PREFIX ?? 'post',
  ...
  POST_RECOMMEND_COUNT: process.env.NEXT_PUBLIC_POST_RECOMMEND_COUNT || 7, // 推荐文章数量
  ...
  // 作废配置
  AVATAR: process.env.NEXT_PUBLIC_AVATAR || '/avatar3.svg', // 作者头像，被notion中的ICON覆盖。若无ICON则取public目录下的avatar.png
